...
const SliderContainer = ({movies}) => {
    ...
    return (
        <SliderWrapper>
            <MovieSlider data={getMoviesBetween(0,10)} title='Mass Collection' />
            ...
            <MovieSlider data={getMoviesBetween(60,70)} title='Users Choice' />
            <MovieSlider data={getMoviesBetween(70,80)} title='Popular on MassMovies' />
        </SliderWrapper>
    )
}
